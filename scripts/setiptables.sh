...
iptables -t nat -I PREROUTING -p tcp -d $myip --dport 8827 -j DNAT --to-destination 192.168.100.127:8888
# Jupyter nbconvert slides access
iptables -t nat -I PREROUTING -p tcp -d $myip --dport 9927 -j DNAT --to-destination 192.168.100.127:9999
