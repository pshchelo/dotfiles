...
beautiful.init(awful.util.getdir("config") .. "/themes/solarized-dark-default/theme.lua")
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    ...
                                    { "close", awful.util.getdir("config") .. "/scripts/shutdown.sh"}
                                  }
                        })
