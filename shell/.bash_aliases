...
alias mosk-dev-sshuttle="sshuttle -e 'ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ~/.ssh/aio_rsa -l ubuntu' -r `ansible-ip mosk.dev.masters` 10.172.1.0/24 10.11.12.0/24"
